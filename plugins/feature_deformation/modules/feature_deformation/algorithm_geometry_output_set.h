...
class algorithm_geometry_output_set : public algorithm<std::shared_ptr<const algorithm_geometry_output_update>, vtkInformation*, double>
{
public:
    /// Default constructor
    algorithm_geometry_output_set() = default;
